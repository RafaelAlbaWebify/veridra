...
ManageProjectIdentity = Annotated[
    RequestIdentity,
...
def build_tenant_project_router(*, root: Path | None = None) -> APIRouter:
    ...
    def list_projects(identity: ReadIdentity) -> list[TenantProjectSummary]:
    ...
    def delete_project(project_id: str, identity: ManageProjectIdentity) -> None:
