...
def analyze_document(html: str, headers: dict[str, str], robots: str = "") -> list[Finding]:
    ...
    findings = [
        ...
        _finding(
            ...
            "Expose clearly labelled organisation information from the homepage.",
            evidence={
                "scope": "homepage",
        ...
        _finding(
            ...
            "contact" in parser.trust_links,
            "Expose a clearly labelled contact route from the homepage.",
            evidence={
                "scope": "homepage",
                "detected_link_types": sorted(parser.trust_links),
            },
        ...
        _finding(
            "trust.privacy",
            "Trust signals",
            "Homepage privacy route",
            "privacy" in parser.trust_links,
            "Expose a clearly labelled privacy or data-protection route from the homepage.",
            evidence={
                "scope": "homepage",
                "detected_link_types": sorted(parser.trust_links),
            },
        ...
        _finding(
            "trust.terms",
            "Trust signals",
            "Homepage terms route",
            "terms" in parser.trust_links,
            "Expose applicable terms or legal information from the homepage when relevant.",
            evidence={
                "scope": "homepage",
                "detected_link_types": sorted(parser.trust_links),
            },
