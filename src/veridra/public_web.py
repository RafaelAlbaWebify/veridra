...
</style></head><body><header><div class='nav'><a class='brand' href='/free'>Veridra</a><div class='nav-actions'><a href='/plans'>Plans</a><a href='/login'>Sign in</a><a class='button' href='/signup'>Create agency workspace</a></div></div></header><main>{body}</main></body></html>"""
